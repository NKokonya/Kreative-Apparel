...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        currencySettings: {
            locales: 'Kenya', // A string with a BCP 47 language tag, or an array of such strings
            currencyOptions: {
                style: 'currency',
                currency: 'Ksh',
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.addClass('card border border-default sc-cart sc-theme-' + this.options.theme);
            this.cart_element.append('<div class="card-header sc-cart-heading">' + this.options.lang.cartTitle + ' <span class="sc-cart-count badge">0</span></div>');
